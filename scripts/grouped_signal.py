...
# Load signal matrix
with open("/home/abportillo/github_repo/Aging/motif_binding/signal_matrix_90.json") as f:
...
# Save to TSV
df.to_csv("/home/abportillo/github_repo/Aging/motif_binding/grouped_signal_matrix_90.tsv", sep="\t")
