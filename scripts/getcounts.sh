...
while IFS=" " read -r sample_name path; do
  ...
  mkdir -p /home/abportillo/github_repo/Aging/fastq/counts_tx
  outdir=/home/abportillo/github_repo/Aging/fastq/counts_tx
...
#SBATCH --output=${outdir}/${sample_name}_getTxCounts_%j.log\n
...
${samtools} view -c -F 4 ${datapath_aging}/${sample_name}_sorted.bam \
...
${stringtie} ${datapath_aging}/${sample_name}_sorted.bam -e -B --rf \
...
${python} /home/abportillo/github_repo/Aging/scripts/getTEtxReadCounts1.py \
${sample_name} \
${outdir} \
  /home/abportillo/github_repo/Aging/fastq/Gencode_TE_counts/Gencode_TE_transcripts.bed
...
${python} /home/abportillo/github_repo/Aging/scripts/getTEtxReadCountsGencode2.py \
${sample_name} \
${outdir} \
  /home/abportillo/github_repo/Aging/fastq/Gencode_TE_counts/Gencode_TE_transcripts.bed
conda deactivate"
